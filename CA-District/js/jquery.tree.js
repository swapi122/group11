				...
				if(this.settings.ui.theme_name !== false) {
					if(this.settings.ui.theme_path === false) {
						$("script").each(function () { 
							if(this.src.toString().match(/jquery\.tree.*?js$/)) {_this.settings.ui.theme_path = "/css/treeview/themes/" + _this.settings.ui.theme_name + "/style.css"; return false; }
						});
					}
